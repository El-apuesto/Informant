...
1. **Remove Filler Words**: Eliminate all filler words and disfluencies (e.g., “um”, “uh”, “like”, “you know”) unless they are essential for the meaning.
1. **Identify Speakers**: Analyze the text and identify different speakers. Label them as “Speaker 1”, “Speaker 2”, etc. If you cannot reliably determine speakers, return an empty list for `speaker_labels`.
1. **Generate Summary**: Create a concise, neutral summary of the conversation’s key points.
...
{“role”: “user”, “content”: f”Here is the raw transcription to process:\n\n—\n\n{transcription_text}”},
],
...
try:
    ...
    # ✅ FIXED: segments are dicts, not objects
